...
# netlist
set coreNet  "../output/riscv_core_scan12.v"
...
#set coreStil "../output/riscv_core_scan12.spf"
set coreStil "../output/riscv_core_scan12_cmp480.spf"
...
report_summaries
#report_patterns -all
write_patterns $outPatterns -replace -first 0 -last 3 -format stil -order_pin
